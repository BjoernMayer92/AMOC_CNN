...
out_dir = "./conv_models/{}".format(datetime_string)

if not os.path.exists(out_dir):
    os.makedirs(out_dir)
    
jupyter_filestem = "cv_conv_model"
for lev_index in lev_index_list:
    for kfold_index in kfold_index_list:
        ...
        pm.execute_notebook(inp_filename, os.path.join(out_dir, out_filename), parameters = {"lev_index": str(lev_index), "kfold_index":str(kfold_index), "datetime_string": datetime_string}, prepare_only=True)
